...
class Command(BaseCommand):
    ...
    def handle(self, string_tunings: List[str], start_fret: int, end_fret):  # type: ignore
        ...
        for index, note in enumerate(strings):
            self.show_string(index, note, end_fret, start_fret)
    ...
    def show_string(self, index, startnote, frets: int, start_fret):
        global fgcolor
